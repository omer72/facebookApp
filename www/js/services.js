angular.module('facebookSrv',[]).factory('FacebookSrv',  ['$window', '$rootScope', '$q', '$http',function($window, $rootScope, $q, $http){
  var FB_LOGIN_URL = 'https://www.facebook.com/dialog/oauth';
        ...
        var login = function(fbScope) {
            ...
            fbScope = fbScope || 'publish_actions'; //email,user_friends,public_profile,user_about_me,user_actions.news,user_actions.video,user_activities,user_events';
            logout();
